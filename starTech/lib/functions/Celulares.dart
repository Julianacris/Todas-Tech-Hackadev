  ...
  Widget build(BuildContext context) {
    return GridView.count(
          ...
          children: const <Widget>[
            Produto(preco: ' R\$ 3.858,57', nome: "Smartphone Motorola Edge 30 Ultra", 
            pathImagem: 'assets/images/celular-motorola.png'),
            Produto(preco: ' R\$ 3.698,99', nome: "Iphone 12 64gb", 
            pathImagem: 'assets/images/iphone-branco.png'),
            Produto(preco: ' R\$ 4.249,00', nome: "Iphone 13 128gb Amarelo", 
            pathImagem: 'assets/images/iphone-amarelo.png'),
            Produto(preco: ' R\$ 2.499,00', nome: "Samsung Galaxy S22", 
            pathImagem: 'assets/images/celular-sansung.png'),
            Produto(preco: ' R\$ 3.779,10', nome: "Samsung Galaxy S22 Ultra", 
            pathImagem: 'assets/images/celular-sansung-s22.png'),
            Produto(preco: ' R\$ 4.249,00', nome: "Iphone 13 128gb Azul", 
